...
def chat_answer(messages, server_url="http://localhost:8080"):
    ...
    client = MCPClient()
    client.connect_to_sse_server(server_url="http://localhost:8080/sse")

    return client.process_query(messages)
...
async def get_mcp_client():
    ...
    await mcp_client.connect_to_sse_server(server_url="http://localhost:8080/sse")
